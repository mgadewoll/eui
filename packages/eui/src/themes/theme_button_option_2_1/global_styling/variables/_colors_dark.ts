...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBorderColorAccent: semantic_colors.highlight60,
  buttonSecondaryBorderColorSuccess: semantic_colors.success60,
  buttonSecondaryBorderColorWarning: semantic_colors.warning60,
  buttonSecondaryBorderColorDanger: semantic_colors.danger60,
