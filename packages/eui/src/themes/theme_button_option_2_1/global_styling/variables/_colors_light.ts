...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBorderColorPrimary: border_colors.borderPrimary,
  buttonSecondaryBorderColorAccent: border_colors.borderAccent,
  buttonSecondaryBorderColorSuccess: border_colors.borderSuccess,
  buttonSecondaryBorderColorWarning: border_colors.borderWarning,
  buttonSecondaryBorderColorDanger: border_colors.borderDanger,
