...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBevelColorPrimary: semantic_colors.shade60,
  buttonSecondaryBevelColorAccent: semantic_colors.shade60,
  buttonSecondaryBevelColorSuccess: semantic_colors.shade60,
  buttonSecondaryBevelColorWarning: semantic_colors.shade60,
  buttonSecondaryBevelColorDanger: semantic_colors.shade60,
  buttonSecondaryBevelColorText: semantic_colors.shade60,
  buttonSecondaryBevelColorDisabled: semantic_colors.shade60,
