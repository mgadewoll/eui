...
export const NEW_THEME_BUTTON_OPTION_3_KEY = 'EUI_THEME_NEW_BUTTON_OPTION_3';

export const euiThemeNewButtonOption3: EuiThemeShape = {
  colors,
  base,
  size,
  border,
...
export const EuiThemeNewButtonOption3 = buildTheme(
  euiThemeNewButtonOption3,
  NEW_THEME_BUTTON_OPTION_3_KEY
);
