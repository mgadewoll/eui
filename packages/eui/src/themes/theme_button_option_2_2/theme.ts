...
export const NEW_THEME_BUTTON_OPTION_2_2_KEY =
  'EUI_THEME_NEW_BUTTON_OPTION_2_2';

export const euiThemeNewButtonOption2_2: EuiThemeShape = {
  colors,
  base,
  size,
  border,
...
export const EuiThemeNewButtonOption2_2 = buildTheme(
  euiThemeNewButtonOption2_2,
  NEW_THEME_BUTTON_OPTION_2_2_KEY
);
