...
export const NEW_THEME_BUTTON_OPTION_4_KEY = 'EUI_THEME_NEW_BUTTON_OPTION_4';

export const euiThemeNewButtonOption4: EuiThemeShape = {
  colors,
  base,
  size,
  border,
...
export const EuiThemeNewButtonOption4 = buildTheme(
  euiThemeNewButtonOption4,
  NEW_THEME_BUTTON_OPTION_4_KEY
);
