...
export const shade_colors: _EuiThemeShadeColors = {
  ...
  fullShade: semantic_colors.black,
};
...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonBackgroundPrimaryHovered: semantic_colors.primary100,
  buttonBackgroundAccent: semantic_colors.accent90,
  buttonBackgroundAccentHovered: semantic_colors.accent100,
  buttonBackgroundSuccess: semantic_colors.success90,
  buttonBackgroundWarning: semantic_colors.warning40,
  buttonBackgroundWarningHovered: semantic_colors.warning50,
  buttonBackgroundDanger: semantic_colors.danger90,
  buttonBackgroundDangerHovered: semantic_colors.danger100,
  buttonBackgroundText: semantic_colors.shade90,
  buttonBackgroundTextHovered: semantic_colors.shade100,
  buttonBackgroundDisabled: semantic_colors.shade20,
  ...
  buttonBorderColorDisabled: semantic_colors.shade20,

  buttonBevelColorPrimary: semantic_colors.primary130,
  buttonBevelColorAccent: semantic_colors.accent130,
  buttonBevelColorSuccess: semantic_colors.success130,
  buttonBevelColorWarning: semantic_colors.warning80,
  buttonBevelColorDanger: semantic_colors.danger130,
  buttonBevelColorText: semantic_colors.shade130,
  buttonBevelColorDisabled: semantic_colors.shade100,
  ...
  buttonSecondaryBackgroundDisabled: semantic_colors.white,
  ...
  buttonSecondaryColorAccent: semantic_colors.accent100,
  ...
  buttonSecondaryColorText: semantic_colors.shade140,
  buttonSecondaryColorDisabled: semantic_colors.shade80,

  buttonSecondaryBorderColorPrimary: semantic_colors.shade30,
  buttonSecondaryBorderColorAccent: semantic_colors.shade30,
  buttonSecondaryBorderColorSuccess: semantic_colors.shade30,
  buttonSecondaryBorderColorWarning: semantic_colors.shade30,
  buttonSecondaryBorderColorDanger: semantic_colors.shade30,
  buttonSecondaryBorderColorText: semantic_colors.shade30,
  buttonSecondaryBorderColorDisabled: semantic_colors.shade30,

  buttonSecondaryBevelColorPrimary: semantic_colors.shade110,
  buttonSecondaryBevelColorAccent: semantic_colors.shade110,
  buttonSecondaryBevelColorSuccess: semantic_colors.shade110,
  buttonSecondaryBevelColorWarning: semantic_colors.shade110,
  buttonSecondaryBevelColorDanger: semantic_colors.shade110,
  buttonSecondaryBevelColorText: semantic_colors.shade110,
  ...
  buttonEmptyColorAccent: semantic_colors.accent100,
  ...
  buttonEmptyColorText: semantic_colors.shade140,
  buttonEmptyColorDisabled: semantic_colors.shade80,
};
