...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBackgroundHovered: background_colors.backgroundSubdued, // style flag
  ...
  buttonSecondaryBorderColorBevelPrimary: border_colors.borderPlain,
  buttonSecondaryBorderColorBevelAccent: border_colors.borderPlain,
  buttonSecondaryBorderColorBevelSuccess: border_colors.borderPlain,
  buttonSecondaryBorderColorBevelWarning: border_colors.borderPlain,
  buttonSecondaryBorderColorBevelDanger: border_colors.borderPlain,
  buttonSecondaryBorderColorBevelText: border_colors.borderPlain,
  buttonSecondaryBorderColorBevelDisabled: border_colors.borderPlain,
