...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBorderColorBevelPrimary: semantic_colors.shade30,
  buttonSecondaryBorderColorBevelAccent: semantic_colors.shade30,
  buttonSecondaryBorderColorBevelSuccess: semantic_colors.shade30,
  buttonSecondaryBorderColorBevelWarning: semantic_colors.shade30,
  buttonSecondaryBorderColorBevelDanger: semantic_colors.shade30,
  buttonSecondaryBorderColorBevelText: semantic_colors.shade30,
  buttonSecondaryBorderColorBevelDisabled: semantic_colors.shade30,
