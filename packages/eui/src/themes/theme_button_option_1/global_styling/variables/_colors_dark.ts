...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBorderColorBevelPrimary: semantic_colors.shade110,
  buttonSecondaryBorderColorBevelAccent: semantic_colors.shade110,
  buttonSecondaryBorderColorBevelSuccess: semantic_colors.shade110,
  buttonSecondaryBorderColorBevelWarning: semantic_colors.shade110,
  buttonSecondaryBorderColorBevelDanger: semantic_colors.shade110,
  buttonSecondaryBorderColorBevelText: semantic_colors.shade110,
  buttonSecondaryBorderColorBevelDisabled: semantic_colors.shade110,
