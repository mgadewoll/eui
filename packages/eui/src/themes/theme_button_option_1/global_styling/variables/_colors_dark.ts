...
const button_colors: _EuiThemeButtonColors = {
  ...
  buttonSecondaryBorderColorPrimary: semantic_colors.shade140,
  buttonSecondaryBorderColorAccent: semantic_colors.shade140,
  buttonSecondaryBorderColorSuccess: semantic_colors.shade140,
  buttonSecondaryBorderColorWarning: semantic_colors.shade140,
  buttonSecondaryBorderColorDanger: semantic_colors.shade140,
  buttonSecondaryBorderColorText: semantic_colors.shade140,
